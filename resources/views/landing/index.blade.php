    ...
    <div class="swiper hero-swiper">
        <div class="swiper-wrapper hero-wrapper">
            <div class="swiper-slide"
                style="background-image: url('{{ asset('hero-slider-one.webp') }}'); background-size: cover; background-position: center; background-repeat: no-repeat;">
                <div class="container">
                    <div class="col-lg-6">
                        <div class="wrapper-section" data-aos="fade-up">
                            <div class="wrapper-info">
                                <h5 class="wrapper-subtitle text-dark">UP TO <span
                                        class="wrapper-inner-title">70%</span> OFF</h5>
            ...
            <div class="swiper-slide"
                style="background-image: url('{{ asset('hero-slider-two.webp') }}'); background-size: cover; background-position: center; background-repeat: no-repeat;">
                <div class="container">
                    <div class="col-lg-6">
            ...
            <div class="swiper-slide"
                style="background-image: url('{{ asset('hero-slider-three.webp') }}'); background-size: cover; background-position: center; background-repeat: no-repeat;">
                <div class="container">
                    <div class="col-lg-6">
                        <div class="wrapper-section">
                            <div class="wrapper-info">
            ...
            <div class="row gy-4 gx-5 gy-lg-0">
                ...
                <div class="col-lg-6">
                    <div class="product-wrapper wrapper-one" data-aos="fade-right"
                        style="background-image: url('{{ asset('syle-bg-one.webp') }}'); background-size: cover; background-position: center; background-repeat: no-repeat;">
                        <div class="wrapper-info">
                ...
                <div class="col-lg-6">
                    <div class="product-wrapper wrapper-two" data-aos="fade-up"
                        style="background-image: url('{{ asset('style-bg-two.webp') }}'); background-size: cover; background-position: center; background-repeat: no-repeat;">
                        <div class="wrapper-info">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="product-wrapper" data-aos="fade-right" data-aos-duration="100">
                        <div class="product-img">
                            <img src="{{ Storage::url($image->image) }}" alt="product-img">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-description">
                                <a href="{{ route('product.show', $product->slug) }}" class="product-details">{{
                                    $product->slug }}</a>
                                <div class="price">
                        ...
                        <div class="product-cart-btn">
                            <a href="{{route('cart.index')}}" class="product-btn">Add To Cart</a>
                        </div>
                    </div>
                </div>
                @endforeach
...
<section class="blog-section pt-100">
    <div class="container">
        <div class="section-heading text-center">
            <h5 class="section-title mb-5 mt-5">Our Latest News Insight</h5>
        </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="post-card">
                    <div class="post-thumb">
                        <img src="{{ Storage::url($post->featured_image) }}" alt="post" height="300px" width="300px">
                    </div>
                    <div class="post-content-wrap">
                        <div class="post-content">
                            <h3 class="title"><a href="{{ route('blog.show', ['blog' => $post->slug]) }}">{{
