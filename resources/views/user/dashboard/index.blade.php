        ...
        <table>
            <tbody>
                ...
                @forelse(auth()->user()->orders as $order)
                    @foreach($order->products as $product) <!-- Assuming 'products' relationship exists -->
                        <tr class="table-row ticket-row">
                            <td class="table-wrapper wrapper-product">
                                <div class="wrapper">
                                    <div class="wrapper-img">
                                        <img src="{{ asset('storage/' . $product->image) }}" alt="img"> <!-- Assuming image is stored this way -->
                                    </div>
                                    <div class="wrapper-content">
                            ...
                            <td class="table-wrapper">
                                <div class="table-wrapper-center">
                                    <h5 class="heading">${{ number_format($product->price, 2) }}</h5>
                                </div>
                            </td>
                            <td class="table-wrapper">
                                <div class="table-wrapper-center">
                                    <div class="quantity">
                                        ...
                                        <span class="number">{{ $product->pivot->quantity }}</span> <!-- Assuming pivot table has 'quantity' -->
                            ...
                            <td class="table-wrapper wrapper-total">
                                <div class="table-wrapper-center">
                                    <h5 class="heading">${{ number_format($product->price * $product->pivot->quantity, 2) }}</h5>
                                </div>
                            </td>
                            <td class="table-wrapper">
                                <div class="table-wrapper-center">
                    ...
                    @forelse(auth()->user()->wishlist as $product)
                        <tr class="table-row ticket-row">
                            <td class="table-wrapper wrapper-product">
                                <div class="wrapper">
                                    <div class="wrapper-img">
                                        <img src="{{ asset('assets/images/homepage-one/product-img/' . $product->image) }}" alt="img">
                                    </div>
                                    <div class="wrapper-content">
                                        <h5 class="heading">{{ $product->name }}</h5>
                                    </div>
